...
const AcceptPage = ({}: AcceptPageProps) => {
    const steps = [
        ...
        <>
            <form onSubmit={handleSubmit(onSubmit, onErrors)} className={"flex flex-col h-full"}>
                <div className="flex flex-col flex-1">
                    <strong className={"mb-6 text-xl text-primary"}>Ce que vous allez faire</strong>
                    <div className="flex flex-col gap-8">
                        ...
                        <Checkbox onChange={() => setAccept1(old => !old)} name={fields.acceptFaceScan as TAccept} defaultValue={accept1} register={register}>
                            <div className="flex flex-col flex-1">
                                ...
                                <a className={"underline"}>Comment sont traitées mes données?</a>
                            </div>
                        </Checkbox>
                        ...
                        <Checkbox onChange={() => setAccept2(old => !old)} name={fields.acceptPolitics as TAccept} defaultValue={accept2} register={register}>
                            <div className="flex flex-col flex-1">
                                <span>J'ai lu et j'accepte la <a className={"underline"}>Politique de confidentialité</a>
                ...
                <div className="flex flex-col gap-6 items-center">
                    <button type={"submit"} disabled={!accept1 || !accept2} className={`text-sm p-2 rounded bg-primary shadow-lg w-full text-white ${!accept1 || !accept2 ? "bg-gray-100 text-gray-400" : ""}`}>
                        J'accepte
                    </button>
